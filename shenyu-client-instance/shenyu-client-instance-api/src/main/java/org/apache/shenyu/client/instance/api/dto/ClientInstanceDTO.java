...
package org.apache.shenyu.client.instance.api.dto;
...
public class ClientInstanceDTO {
     ...
     * @param port the port
     */
    public ClientInstanceDTO(final String appName, final String host, final Integer port) {
    ...
    private ClientInstanceDTO(final Builder builder) {
    ...
    public boolean equals(final Object o) {
        ...
        ClientInstanceDTO that = (ClientInstanceDTO) o;
    ...
    public static final class Builder {
         ...
         */
        public ClientInstanceDTO build() {
            return new ClientInstanceDTO(this);
        }
    }
}
